...
class Game < ActiveRecord::Base
  ...
  #   меняется :current_level, :prize (если несгораемый уровень),
  # поля :updated_at
  #   прописывается :finished_at если это был последний вопрос
  #
  # возвращает false — если 1) ответ неверный,
  # 2) время вышло 3) игра уже закончена ранее
  #   в любом случае прописывается :finished_at,
  # :prize (если несгораемый уровень), :updated_at
